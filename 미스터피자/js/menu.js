...
$(function () {
  $('.menu_btn ul li .aaa').hover(function (){
...
$('.menu_btn ul li .aaa').css("background-position"," center center");
      ...
      $('.menu_btn ul li .aaa').css("background","url(https://cdn.mrpizza.co.kr/2014_resources/images/product/ic_memu01.gif)"); // 기본값으로 되돌림
...
$(function () {
  $('.menu_btn ul li .b').hover(function (){
...
$('.menu_btn ul li .b').css("background-position"," center center");
      ...
      $('.menu_btn ul li .b').css("background","url(https://cdn.mrpizza.co.kr/2014_resources/images/product/ic_memu02.gif)"); // 기본값으로 되돌림
...
$(function () {
  $('.menu_btn ul li .c').hover(function (){
...
$('.menu_btn ul li .c').css("background-position"," center center");
      ...
      $('.menu_btn ul li .c').css("background","url(https://cdn.mrpizza.co.kr/2014_resources/images/product/ic_memu03.gif)"); // 기본값으로 되돌림
...
$(function () { //FIXME -   나중에 좀 더 수정할것
  $('.option1').click(function (e){
    e.preventDefault();
$('article img.pizza1 ').attr("src","../image/../image/2023314151710070.jpg"); // 기본값으로 되돌림
})
  $('.option2').click(function (e){
    e.preventDefault();
$('article img.pizza1 ').attr("src","../image/20233141521172.jpg"); // 기본값으로 되돌림
})
$('.option3').click(function (e){
  e.preventDefault();
$('article img.pizza1 ').attr("src","../image/2023314142859082.jpg"); // 기본값으로 되돌림
})
